package com.example.survivorbird1;
...
public class SurvivorBird extends ApplicationAdapter {
    ...
    public void render() {
        ...
        velocity+=speed * Gdx.graphics.getDeltaTime();
        birdY -= velocity;
        ...
        if(gameState == 1) {
            ...
            if(birdY>Gdx.graphics.getHeight()-bird.getHeight()) {
                birdY = Gdx.graphics.getHeight() - bird.getHeight();
                velocity = 0;
            }
